...
public interface StoryService extends ImageService<StoryResponse, Long> {
    StoryResponse save(MultipartFile file, String title, ContentType contentType, Category category) throws IOException;

    List<StoryResponse> getAllTodayStories();

    List<StoryResponse> getAllByCategory(Category category);
}
